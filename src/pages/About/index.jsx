...
// create and export
const About = ({ title, subtitle, author, date, image, text }) => (
  <article className="container">
    <section className="content">
      ...
      <div className="content__text">
        <p>
        Somos un equipo que desarrollamos una herramienta pensando en ti, permite ver de manera rapida y fluida las noticas mas importantes del mundo al instante.
        </p>
        <br/>
        <p>
        No tienes que precuparte por visitar los portales de noticias, <code>News INC </code> agrupa las noticias mas importantes para ti , ademas puedes 
        buscar por categorias y tags.
        </p><br></br>

        <div className="content__text-tecnologic">
          <h2> Tecnologias</h2>
          <span>Frontend</span>
          <div className='content__about-img'>
